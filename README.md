...
| `GET /api/odoo/sales-compare?bu=all|<ชื่อ BU>&years=5` | เปรียบเทียบยอดขาย: รายปี (YoY, ตัดยอดถึงวันเดียวกันของทุกปี) + 12 เดือนล่าสุดพร้อมยอดเดือนก่อน/เดือนเดียวกันปีก่อน + MTD 3 ช่วง (cache 5 นาที) |
